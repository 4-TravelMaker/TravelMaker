...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/resources/css/Theme/ThemeCoupleTrip.css">
            ...
            <section class="container">
                ...
                <section class="container7">
                    <section class="container7-1">
                        <img src="${contextPath}/resources/images/ThemeBoard/CoupleTrip/CoupleTripSub.jpg">
                    </section>
                </section>
                ...
                <section class="container9">
                    <section class="container9-1">
                        <section class="item3">
                            <img src="${contextPath}/resources/images/ThemeBoard/CoupleTrip/CoupleTripArt2.jpg">
                        </section>
                        <section class="item3">
                            <img src="${contextPath}/resources/images/ThemeBoard/CoupleTrip/CoupleTripBongridan2.jpg">
                        </section>
                ...
                <section class="container9">
                    <section class="container9-1">
                        <section class="item3">
                            <img src="${contextPath}/resources/images/ThemeBoard/CoupleTrip/CoupleTripSky2.jpg">
                        </section>
                        <section class="item3">
                            <img src="${contextPath}/resources/images/ThemeBoard/CoupleTrip/CoupleTripThemePark2.jpg">
                        </section>
