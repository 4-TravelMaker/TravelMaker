    ...
    <main>
        ...
        <section id="middle1">
            <section class = "title">
                <p>저구항</p>
                <p>경남 거제시</p>
                <mark>아름답게 피어난 수국과 함께 푸른 바다를 걸어보자 !</mark>
                <hr>
            </section>
            <section class="like">
                <p>좋아요</p>
            ...
            <section class="article">
                <p>상세정보</p>
                <hr>
                <pre>경남 거제시 남부면 저구리에 위치한 ''저구항''은 수국 동산이 있어 바다와 함께 수국을 보기 좋은 곳이다. 야생 수국이 아닌 동산으로 조성이 되어 있으며, 데크길과 산책로, 지압길 등이 잘 꾸며져 있으며, 항구의 남쪽에는 한려해상국립공원에 속하는 명사해수욕장이 있으며 저구마을, 명사마을, 근포마을, 대포마을이 있다.</pre>
            </section>
            <section class="map">
                <section id="map-area">
